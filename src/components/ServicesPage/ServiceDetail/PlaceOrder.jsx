...
function PlaceOrder({ css, pkgId, goBack }) {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`/api/users/orders/freelancer/PlaceOrder`, requestOptions)
  ...
  return (
    <div
      className={
        css +
        " bg-white rounded-2xl shadow-[rgba(0,_0,_0,_0.24)_0px_0px_30px] p-6"
      }
    >
      <div className=" relative font-semibold text-center text-4xl py-4 flex gap-4 items-center justify-center">
        ...
        />
        <h1>Place </h1> <span className=" text-primary">Order</span>{" "}
      </div>
      <form onSubmit={handleSubmit} className="grid flex-wrap gap-8 w-full">
        ...
        <div>
          ...
          <input
            ...
            id="title"
            value={title}
            placeholder="Title of your order"
