...
function ServicesB({ userServices = [] }) {
  ...
  async function handleAddService() {
    ...
    setUserServicesState((oldSkills) => [
      ...oldSkills,
...
export default dynamic(() => Promise.resolve(ServicesB), { ssr: false });
